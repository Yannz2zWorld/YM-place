...
(function () {
  ...
  const PAYMENT_ACCOUNTS = {
    qris:      { label: 'QRIS',       number: '0005843892689',  logo: '' },
    dana:      { label: 'Dana',       number: '0852-8242-6298', logo: '' },
    gopay:     { label: 'GoPay',      number: '0852-8242-6298', logo: '' },
  ...
  const products = [

    {
      ...
      icon: '',
      img: 'image/1.png',
      desc: 'Script bot WA premium dengan fitur AI, download media, dan 1600+ fitur premium + free update selamanya.',
      stock: 'unlimited',
      badge: 'trend',
    },
    {
      ...
      return `
        <div class="checkout-modal" id="payModal">
          ...
          <div class="checkout-body">
            ...
            <div class="qr-wrap">
              ${methodKey === 'qris'
                ? `<img src="image/qris.png" alt="QRIS" style="width:200px;height:200px;object-fit:contain;">`
            ...
            <div class="pay-number-wrap">
              <div>
                <div style="font-size:11px;color:var(--muted2);margin-bottom:4px">${methodKey === 'qris' ? 'Nomor QRIS' : `Nomor ${method.label}`}</div>
