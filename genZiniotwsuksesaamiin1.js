...
(function () {
  ...
  const PAYMENT_ACCOUNTS = {
    pakasir:     { label: 'QRIS AUTO', number: '', logo: '' },
    qris_backup: { label: 'QRIS Biasa',  number: 'QRIS', logo: '️', img: 'https://img2.pixhost.to/images/8805/741958354_yannganteng-1782136284044.png' },
          ...
          <div class="checkout-body">
            ...
            <div class="qr-wrap">
              ${method.img
                ...
                : `<div class="qr-placeholder"><div class="qr-icon">${method.logo}</div><p>Bayar ke ${method.label}</p></div>`
              }
            </div>
            <!-- Nomor Pembayaran -->
            ${method.img ? '' : `
